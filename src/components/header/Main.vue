<template>
  <header
    ...
    <router-link
      :to="{ name: 'home' }"
      class="logo-container pl-4 md:pl-8 w-50px md:w-100px h-50px md:h-80px flex-none text-2xl xl:rounded-l-md flex justify-center items-center">
      <img class="logo" src="@/assets/images/bpl-logo.png" />
    </router-link>
